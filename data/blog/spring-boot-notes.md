...
summary: Spring Boot 是 Spring 框架的框架，提供一些开箱即用的配置。本文主要介绍了 Spring Boot 的核心特性：IOC、MVC、AOP、DAF，以及 Spring Bean 的生命周期管理、依赖注入、Spring Data JPA 等内容。
draft: false
---
...
## DispatcherServlet
![alt text](/static/images/blog/7b8817122aa542e7b8e997ef5120688c.png)
...
![alt text](/static/images/blog/CleanShot 2024-03-14 at 01.25.53.png)
...
### Interface Hierarchy
![alt text](/static/images/blog/9c4e4c00c7a64047b819874635b4f7f9~tplv-k3u1fbpfcp-zoom-1.image.png)
...
![alt text](/static/images/blog/CleanShot 2024-03-16 at 15.27.26.png)
...
![alt text](/static/images/blog/CleanShot 2024-03-23 at 12.22.00.png)
